...
public class AppointmentDTO {
    ...
    public AppointmentDTO(Long id, Long doctorId, String doctorName, Long patientId, String patientName, String patientEmail,
                          String patientPhone, String patientAddress, java.time.LocalDateTime appointmentTime, int status) {
        this.id = id;
        ...
        this.status = status;
        this.appointmentDate = appointmentTime.toLocalDate(); // Extract date part
